...
#+RESULTS:
<<<<<<< HEAD
: #<font-spec nil nil Iosevka nil nil nil nil nil 20 nil nil nil nil>
=======
: #<font-spec nil nil Iosevka nil nil nil nil nil 19 nil nil nil nil>
...
#+RESULTS:
: [nil 24242 38634 639763 nil mu4e-alert--get-mu-unread-emails-1 (mu4e-alert--email-processor) nil 214000]
...
#+RESULTS:
| t | TODO | entry | (file+headline ~/org/actions.org Other) | * TODO [#A] %? |
...
#+RESULTS:
<<<<<<< HEAD
| c | cite-ref | plain | (function org-roam-capture--get-point) |   | :file-name | refs/${slug} | :head | #+title: Notes on: ${title} (${author-or-editor}, ${year}) |
=======
| r | ref | plain | (function org-roam-capture--get-point) |   | :file-name | ${slug} | :head | #+TITLE: Notes on: ${title} (${author-or-editor}, ${year}) |
...
#+end_src
=======
| org-src-babel-configure-edit-buffer | org-src-mode-configure-edit-buffer | doom-modeline-set-org-src-modeline | lsp | lsp-org |
>>>>>>> b82daab096699c6f23e3a923d8081c7573062528
